...
const FingerSelectPain = () => {
  ...
  return (
    <div className='container flex flex-row relative'>
        ...
        2xl:top-[180px] 2xl:right-[470px] 2xl:px-[18px] 2xl:p-[14px] -rotate-45 rounded-ful' onClick={handleTopFingerClick}/>
        ...
        2xl:top-[100px] 2xl:right-[390px] 2xl:px-[18px] 2xl:p-[14px] rounded-ful' onClick={handleTopFingerClick}/>
        ...
        2xl:top-[68px] 2xl:right-[322px] 2xl:px-[20px] 2xl:p-[14px] rounded-ful' onClick={handleTopFingerClick}/>
        ...
        2xl:top-[85px] 2xl:right-[245px] 2xl:px-[19px] 2xl:p-[14px] rounded-ful' onClick={handleTopFingerClick}/>
        ...
        2xl:top-[235px] 2xl:right-[448px] 2xl:px-[18px] 2xl:p-[14px] -rotate-12 rounded-full' onClick={handleMidFingerClick}/>
        ...
        2xl:top-[178px] 2xl:right-[380px] 2xl:px-[22px] 2xl:p-[14px] -rotate-12 rounded-full' onClick={handleMidFingerClick}/>
        ...
        2xl:top-[150px] 2xl:right-[314px] 2xl:px-[22px] 2xl:p-[14px] rounded-full' onClick={handleMidFingerClick}/>
        ...
        2xl:top-[160px] 2xl:right-[240px] 2xl:px-[23px] 2xl:p-[14px] rounded-full' onClick={handleMidFingerClick}/>
        ...
        2xl:top-[305px] 2xl:right-[112px] 2xl:px-[20px] 2xl:p-[16px] rotate-45 rounded-full' onClick={handleMidFingerClick}/>
        ...
        2xl:top-[302px] 2xl:right-[409px] 2xl:px-[26px] 2xl:p-[18px] -rotate-12 rounded-full' onClick={handleBottomFingerClick}/>
        ...
        2xl:top-[278px] 2xl:right-[358px] 2xl:px-[26px] 2xl:p-[18px] -rotate-12 rounded-full ' onClick={handleBottomFingerClick}/>
        ...
        2xl:top-[260px] 2xl:right-[300px] 2xl:px-[27px] 2xl:p-[18px] rounded-full' onClick={handleBottomFingerClick}/>
        ...
        2xl:top-[263px] 2xl:right-[243px] 2xl:px-[26px] 2xl:p-[18px] rotate-12 rounded-full' onClick={handleBottomFingerClick}/>
        ...
        2xl:top-[392px] 2xl:right-[155px] 2xl:px-[26px] 2xl:p-[18px] rotate-45 rounded-full ' onClick={handleBottomFingerClick}/>
    </div>
  )
}
