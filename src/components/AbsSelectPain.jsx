...
const AbsSelectPain = () => {
  ...
  return (
    <div className='container flex flex-row relative'>
        ...
        2xl:top-[270px] 2xl:right-[298px] 2xl:p-[36px] rotate-45 rounded-xl' onClick={handleTopAbsClick}/>
        ...
        2xl:top-[320px] 2xl:right-[230px] 2xl:px-[38px] 2xl:p-[35px] rotate-45 rounded-full' onClick={handleLuqAbsClick}/>
        ...
        2xl:top-[405px] 2xl:right-[235px] 2xl:px-[32px] 2xl:p-[36px] rotate-45 rounded-3xl' onClick={handleLlqAbsClick}/>
        ...
        2xl:top-[320px] 2xl:right-[355px] 2xl:px-[38px] 2xl:p-[35px] -rotate-45 rounded-full' onClick={handleRuqAbsClick}/>
        ...
        2xl:top-[405px] 2xl:right-[365px] 2xl:px-[32px] 2xl:p-[36px] -rotate-45 rounded-3xl' onClick={handleRlqAbsClick}/>
        ...
        2xl:top-[370px] 2xl:right-[300px] 2xl:px-[32px] 2xl:p-[32px] -rotate-45 rounded-full' onClick={handleMidAbsClick}/>
        ...
        2xl:top-[450px] 2xl:right-[295px] 2xl:p-[34px] -rotate-45 rounded-3xl' onClick={handleBottomAbsClick}/>
